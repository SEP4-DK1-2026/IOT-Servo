 ...
 * @return WIFI_ERROR_MESSAGE_t Error message based on the response from the module.
 */
WIFI_ERROR_MESSAGE_t wifi_command_create_TCP_connection(const char *IP, uint16_t port, WIFI_TCP_Callback_t callback_when_message_received, char *received_message_buffer); //tilføjet const
